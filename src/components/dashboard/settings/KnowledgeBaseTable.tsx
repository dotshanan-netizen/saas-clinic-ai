      ...
      <div className="bg-zinc-900/50 backdrop-blur-md border border-zinc-800 rounded-2xl p-6 shadow-xl">
        ...
        {items.length === 0 ? (
          <div className="flex flex-col items-center justify-center text-center py-16 px-4 border border-dashed border-zinc-800/60 rounded-2xl bg-zinc-900/30">
            ...
            <h3 className="text-zinc-200 font-bold mb-2">لا توجد بيانات مسجلة</h3>
            <p className="text-zinc-500 text-xs max-w-sm leading-relaxed mb-6">
              لم يتم إضافة أي مستندات أو بيانات معرفية في هذا القسم حتى الآن. أضف البيانات لمساعدة الذكاء الاصطناعي في الرد على استفسارات المرضى بشكل دقيق.
            </p>
            <button
              onClick={handleAddNew}
