...
export function runFallbackSimulation(history: ChatMessage[], clinic: ClinicWithCatalog, clientPhone: string) {
...
`;
  ...
  if (
    ...
    if (!existingBooking) {
      ...
      // Update the assistant message in conversation to match the duplicate response override
